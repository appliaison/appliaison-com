...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden">
	...
	<div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
		...
		<h1 class="text-5xl sm:text-6xl lg:text-7xl font-bold mb-6 animate-slide-up">
			<span class="text-gradient">AppLiaison</span>
		</h1>

		<!-- Subheading -->
		<p class="text-xl sm:text-2xl text-gray-400 mb-4 animate-slide-up" style="animation-delay: 0.1s;">
			Full-Stack App Development Agency
		</p>

		<!-- Description -->
		<p class="text-lg text-gray-500 mb-8 max-w-2xl mx-auto animate-slide-up" style="animation-delay: 0.2s;">
			Empowering businesses with state-of-the-art mobile, cloud, and AI solutions.
			We deliver transformative B2B and B2C applications that streamline operations, enhance user experiences, and drive growth.
		</p>
